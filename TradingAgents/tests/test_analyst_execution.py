...
class PropagatorRagContextTests(unittest.TestCase):
    def test_initial_state_accepts_rag_contexts(self):
        ...
        self.assertTrue(state["rag_contexts"]["News Analyst"].startswith("## Retrieved"))
