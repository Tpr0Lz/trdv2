...
def build_instrument_context(
    ...
    if asset_type == "macro":
        return (
            f"The macro indicator to analyze is `{ticker}`. Treat it as a FRED "
            "series alias or series ID, not as a stock or crypto ticker. Use this "
            "exact identifier in macro data tool calls and do not request company "
            "fundamentals, OHLCV prices, or ticker-specific social/news data."
        )
